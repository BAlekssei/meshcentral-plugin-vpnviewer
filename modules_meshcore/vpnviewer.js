...
// ВАЖНО: регистрируемся в ГЛОБАЛЬНОМ `plugins`.
// НИКАКИХ `module.exports` И НИКАКОГО `pluginHandler` ЗДЕСЬ!

(function () {
  if (typeof plugins !== 'object') { return; }   // если по какой-то причине нет реестра — выходим
